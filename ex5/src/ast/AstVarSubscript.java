...
public class AstVarSubscript extends AstVar {
	...
	/********************************************************/
	/* IR generation for subscript variable */
	/* Loads base address of array, evaluates index, */
	/* then emits IrCommandArrayGet */
	/********************************************************/
	public Temp irMe() {
		// Get the base array address
		Temp base = var.irMe();

		// Evaluate the subscript index
		Temp index = subscript.irMe();

		// Load element: dst := arr[index]
		Temp dst = TempFactory.getInstance().getFreshTemp();
		Ir.getInstance().AddIrCommand(new IrCommandArrayGet(dst, base, index));
